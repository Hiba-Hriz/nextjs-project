...
const Hero = () => {
  return (
    <div className='pb-20 pt-36 md:pb-16 md:pt-12 lg:pb-14 lg:pt-10 min-h-screen'>
        ...
        <div className="h-[79vh] lg:h-[89vh] w-full dark:blue dark:bg-black-100  flex 
    ...
    <div className='flex justify-center relative my-8 lg:my-20
    z-10'>
      <div className='max-w-[89vw] md:max-w-2xl 
      lg:max-w-[60vw] flex flex-col items-center
      justify-center'>
        <h2 className='uppercase tracking-widest
        text-xs text-center   text-blue-100 max-w-80 -mt-24 md:mt-0'>
          projets ERP
        </h2>
        <TextGenerateEffect 
        ...
        />
        <p className='text-center md:tracking-wider mb-0 text-sm md:text-lg lg:text-2xl text-white'>
