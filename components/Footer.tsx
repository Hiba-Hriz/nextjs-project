...
const Footer = () => {
  return (
    ...
    <p className='md:text-base pt-2 text-sm md:front-normal  font-light text-bold text-black  mb-0 text-center'>Copyright © 2024 MSI-Consultants. Tous les droits sont réservés.</p>
        </div>
